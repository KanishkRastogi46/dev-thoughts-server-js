...
export const profileTable = pgTable('profile', {
    ...
    code: text('code'),
    posts: integer('posts').references(() => postsTable.id, { onDelete: 'set null' }).array().default([]),
    comments: integer('comments').references(() => commentsTable.id, { onDelete: 'set null' }).array().default([]),
